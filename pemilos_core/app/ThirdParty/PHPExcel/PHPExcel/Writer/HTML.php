            ...
            if ($drawing instanceof PHPExcel_Worksheet_Drawing) {
                if ($drawing->getCoordinates() == $coordinates) {
                    ...
                    $html .= '<img style="position: absolute; z-index: 1; left: ' .
                        ...
                        $drawing->getWidth() . 'px; height: ' . $drawing->getHeight() . 'px;" src="<?= base_url(); ?>' .
                        $imageData . '" border="0" />';
                    $html .= '</div>';
                }
                ...
                $html .= '<img src="<?= base_url(); ?>' . $dataUri . '" style="max-width:100%;width:' . $drawing->getWidth() . 'px;" />';
            }
        }
            ...
            if ($chart instanceof PHPExcel_Chart) {
                ...
                if ($chartCoordinates['cell'] == $coordinates) {
                    ...
                    if ($fp = fopen($chartFileName, "rb", 0)) {
                        ...
                        $html .= '<div style="position: relative;">';
                        $html .= '<img style="position: absolute; z-index: 1; left: ' . $chartCoordinates['xOffset'] . 'px; top: ' . $chartCoordinates['yOffset'] . 'px; width: ' . $imageDetails[0] . 'px; height: ' . $imageDetails[1] . 'px;" src="<?= base_url(); ?>' . $imageData . '" border="0" />' . PHP_EOL;
                        $html .= '</div>';
            ...
            foreach ($pValues as $cellAddress) {
                ...
                if ($cell instanceof PHPExcel_Cell) {
                    ...
                    if (!$this->useInlineCss) {
                        ...
                        if (
                            $sharedStyle->getAlignment()->getHorizontal() == PHPExcel_Style_Alignment::HORIZONTAL_GENERAL
